...
from util import smsPurposeEnum, user_update_payload
...
def verifyMobileNumberService(data, db):
    ...
    lastVeficationCode = Transactions.get_newest_otp_by_userid(user_id=numberAvailability['data'][0]['id'], db=db, purpose=data.purpose)
